...
def extract_rtmpose_landmarks(
    ...
    *,
    ...
    # Fast sources only; a slower source is passed through at its own rate, and
    # that is safe only because ensure_cfr normalises a constant-but-slow clip
    # to target_fps upstream.
